...
import broImg from "../Assets/utilImages/bro.svg";
...
export const TeacherHome = () => {
  ...
  return (
    <Box sx={{ backgroundColor: "#EAE9E9", height: "100vh" }}>
      <Header />
      <Grid container mt={4} px={4} gap={3}>
        <Grid
          item
          xs={6}
          p={4}
        ...
        >
          <Typography variant="h4" fontWeight={"bold"} pl={5}>
            Hi {username}!!
          </Typography>
          <Box>
      ...
      <Box
        ...
        p={5}
      >
        <Grid container m={"auto"} justifyContent={"space-evenly"}>
          <Grid
            item
            xs={3.6}
